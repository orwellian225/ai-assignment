...
class FishyEntropy(rc.Player):
    def __init__(self):
        self.colour = False
        self.my_board = None
        self.current_move = 0
        self.states = set()
        self.logger = logging.getLogger('entropic.non-random-search')
        logging.basicConfig(filename="improved-3.log", encoding="utf-8", level=logging.DEBUG)
